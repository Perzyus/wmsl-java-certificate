...
public class Test {
	...
	public static void main(String[] args) {
		List<Integer> nums = Arrays.asList(5, 10,20,8);
...
//				nums.stream().max(comp).get()
				...
				/*B*/
//				nums.stream().max(Integer::max).get() //Integer::max not a Comparator reference : https://www.programcreek.com/2014/01/why-stream-maxintegermax-compile/
